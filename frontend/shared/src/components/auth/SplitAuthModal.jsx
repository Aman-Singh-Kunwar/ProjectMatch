...
import { dbuuLogoBig, login, register, redirectToPortal } from '@projectmatch/shared';

export default function SplitAuthModal({ showModal, setShowModal, initialMode = 'login', initialRole = 'student' }) {
  ...
  useEffect(() => {
    setMode(initialMode);
    setRole(initialRole);
  }, [initialMode, initialRole, showModal]);
    ...
    >
      ...
      <div
        style={{
          ...
          position: 'relative',
          background: '#FFFFFF',
          boxShadow: '0 32px 64px -12px rgba(0, 0, 0, 0.45), 0 0 0 1px rgba(255, 255, 255, 0.15)',
          display: 'flex',
        }}
      >
        {/* Close Button */}
        <button
          ...
          style={{
            position: 'absolute',
            top: '1.25rem',
            right: isRegister ? 'auto' : '1.25rem',
            left: isRegister ? '1.25rem' : 'auto',
            zIndex: 20,
        ...
        <div
          style={{
            ...
            left: 0,
            zIndex: 10,
            background: 'linear-gradient(155deg, #7A0A1D 0%, #C41230 60%, #9A0E26 100%)',
            color: '#FFFFFF',
            padding: '38px 34px',
            display: 'flex',
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            ...
            >
              ProjectMatch <span style={{ color: '#FFD700', textShadow: '0 2px 8px rgba(0,0,0,0.25)' }}>System</span>
            </h2>
            ...
            >
              {isRegister
                ? 'Join Dev Bhoomi Uttarakhand University capstone portal. Match faculty pool ideas, form student teams, and manage project milestones.'
                : 'Welcome to your academic workspace. Design, analyze, form team proposals, and manage automated review queues across all SOEC departments.'}
            </p>

            {/* ENHANCED CONTEXT SIDE SWITCH CARD */}
            <div
              style={{
        ...
        >
          ...
          <div style={{ marginBottom: '18px' }}>
            ...
            <p style={{ fontSize: '13px', color: 'var(--ink-soft, #4A4A4A)', marginTop: '4px' }}>
              Sign in to your academic portal workspace
            </p>
          </div>
